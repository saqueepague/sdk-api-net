...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class Cip : IEquatable<Cip>
    { 
        /// <summary>
        ...
        /// </summary>
        /// <value>Valor do abatimento calculado (12 dígitos, incluindo centavos).</value>
        ...
        /// </summary>
        /// <value>Tipo de valor aceito.</value>
        ...
        /// </summary>
        /// <value>Valor mínimo de pagamento (12 dígitos, incluindo centavos).</value>
        ...
        /// </summary>
        /// <value>Valor máximo de pagamento (12 dígitos, incluindo centavos).</value>
        ...
        /// </summary>
        /// <value>Número de identificação da consulta.</value>
        [DataMember(Name="NumeroIdentificacaoConsultaPagamento")]
        public string NumeroIdentificacaoConsultaPagamento { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NumeroIdentificacaoConsultaPagamento: ").Append(NumeroIdentificacaoConsultaPagamento).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((Cip)obj);
        }

        /// <summary>
        /// Returns true if Cip instances are equal
        /// </summary>
        /// <param name="other">Instance of Cip to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Cip other)
        {
            ...
            return 
                ...
                (
                    NumeroIdentificacaoConsultaPagamento == other.NumeroIdentificacaoConsultaPagamento ||
                    NumeroIdentificacaoConsultaPagamento != null &&
                    NumeroIdentificacaoConsultaPagamento.Equals(other.NumeroIdentificacaoConsultaPagamento)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (NumeroIdentificacaoConsultaPagamento != null)
                    hashCode = hashCode * 59 + NumeroIdentificacaoConsultaPagamento.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(Cip left, Cip right)
        {
