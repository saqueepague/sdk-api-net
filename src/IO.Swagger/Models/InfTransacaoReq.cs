...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <value>Código fornecido pelo parceiro que identifica a Fintech (máximo 20 dígitos). Campo utilizado somente para parceiros que operam no modelo HUB.</value>
        [DataMember(Name="fintechCode")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FintechCode: ").Append(FintechCode).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InfTransacaoReq other)
        {
            ...
            return 
                ...
                (
                    FintechCode == other.FintechCode ||
                    FintechCode != null &&
                    FintechCode.Equals(other.FintechCode)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (FintechCode != null)
                    hashCode = hashCode * 59 + FintechCode.GetHashCode();
                return hashCode;
            }
        }
