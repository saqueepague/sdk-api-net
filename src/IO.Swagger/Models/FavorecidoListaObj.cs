...
{ 
    ...
    { 
        /// <summary>
        /// Gets or Sets Favorecido
        /// </summary>
        [Required]
        [DataMember(Name="favorecido")]
        public FavorecidoListaObjFavorecido Favorecido { get; set; }
        ...
        public bool Equals(FavorecidoListaObj other)
        {
            ...
            return 
                (
                    Favorecido == other.Favorecido ||
                    Favorecido != null &&
                    Favorecido.Equals(other.Favorecido)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Favorecido != null)
                    hashCode = hashCode * 59 + Favorecido.GetHashCode();
                return hashCode;
            }
        }
