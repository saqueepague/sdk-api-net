...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class RecargaResp : IEquatable<RecargaResp>
    { 
        /// <summary>
        /// Gets or Sets Cripto
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets InfRecarga
        /// </summary>
        [Required]
        [DataMember(Name="InfRecarga")]
        public InfRecargaResp InfRecarga { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InfRecarga: ").Append(InfRecarga).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RecargaResp)obj);
        }

        /// <summary>
        /// Returns true if RecargaResp instances are equal
        /// </summary>
        /// <param name="other">Instance of RecargaResp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecargaResp other)
        {
            ...
            return 
                ...
                (
                    InfRecarga == other.InfRecarga ||
                    InfRecarga != null &&
                    InfRecarga.Equals(other.InfRecarga)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (InfRecarga != null)
                    hashCode = hashCode * 59 + InfRecarga.GetHashCode();
        ...
        public static bool operator ==(RecargaResp left, RecargaResp right)
        {
