...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DepositoResp : IEquatable<DepositoResp>
    { 
        /// <summary>
        /// Gets or Sets Cripto
        /// </summary>
        ...
        /// <summary>
        /// Gets or Sets InfDeposito
        /// </summary>
        [Required]
        [DataMember(Name="InfDeposito")]
        public InfDepositoResp InfDeposito { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InfDeposito: ").Append(InfDeposito).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DepositoResp)obj);
        }

        /// <summary>
        /// Returns true if DepositoResp instances are equal
        /// </summary>
        /// <param name="other">Instance of DepositoResp to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DepositoResp other)
        {
            ...
            return 
                ...
                (
                    InfDeposito == other.InfDeposito ||
                    InfDeposito != null &&
                    InfDeposito.Equals(other.InfDeposito)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (InfDeposito != null)
                    hashCode = hashCode * 59 + InfDeposito.GetHashCode();
        ...
        public static bool operator ==(DepositoResp left, DepositoResp right)
        {
