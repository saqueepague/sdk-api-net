...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <value>Valor total disponível para empréstimo (12 caracteres, incluindo centavos).</value>
        [Required]
        [DataMember(Name="valorTotalDisponivel")]
        public string ValorTotalDisponivel { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  ValorTotalDisponivel: ").Append(ValorTotalDisponivel).Append("\n");
        ...
        public bool Equals(InfConsultaParcelasEmprestimoResp other)
        {
            ...
            return 
                ...
                (
                    ValorTotalDisponivel == other.ValorTotalDisponivel ||
                    ValorTotalDisponivel != null &&
                    ValorTotalDisponivel.Equals(other.ValorTotalDisponivel)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    hashCode = hashCode * 59 + ValorTotalDisponivel.GetHashCode();
