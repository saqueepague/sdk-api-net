...
{ 
    ...
    { 
        ...
        /// </summary>
        /// <value>Número do CPF do portador (11 dígitos).</value>
        [DataMember(Name="cpfPortador")]
        public string CpfPortador { get; set; }

        /// <summary>
        /// Data de nascimento do portador (AAAA-MM-DD).
        /// </summary>
        /// <value>Data de nascimento do portador (AAAA-MM-DD).</value>
        [DataMember(Name="dataNascPortador")]
        public string DataNascPortador { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CpfPortador: ").Append(CpfPortador).Append("\n");
            sb.Append("  DataNascPortador: ").Append(DataNascPortador).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(InfDepositoReq other)
        {
            ...
            return 
                ...
                (
                    CpfPortador == other.CpfPortador ||
                    CpfPortador != null &&
                    CpfPortador.Equals(other.CpfPortador)
                ) && 
                (
                    DataNascPortador == other.DataNascPortador ||
                    DataNascPortador != null &&
                    DataNascPortador.Equals(other.DataNascPortador)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (CpfPortador != null)
                    hashCode = hashCode * 59 + CpfPortador.GetHashCode();
                    if (DataNascPortador != null)
                    hashCode = hashCode * 59 + DataNascPortador.GetHashCode();
                return hashCode;
            }
        }
