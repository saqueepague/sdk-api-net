    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    c.SwaggerDoc("1.17.1-sw2", new Info
                    {
                        Version = "1.17.1-sw2",
                    ...
                    c.DocumentFilter<BasePathFilter>("/saqueepague/SepTransaction/v1");
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            app
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/swagger/1.17.1-sw2/swagger.json", "Saque e Pague Transacional");
